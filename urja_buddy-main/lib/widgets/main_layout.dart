...
class _MainLayoutState extends ConsumerState<MainLayout> {
  ...
  // Bottom nav bar index → actual page index mapping
  // Bottom bar: 0=Dashboard, 1=Smart Alerts, 2=Appliances, 3=Settings
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              // ✅ Profile avatar — tap karo Settings pe jaao
              Tooltip(
                message: 'Go to Settings',
                child: MouseRegion(
                  cursor: SystemMouseCursors.click,
                  child: GestureDetector(
                    onTap: () => widget.onIndexChanged(3), // 3 = Settings
                    child: CircleAvatar(
                      radius: 18,
                      backgroundColor:
