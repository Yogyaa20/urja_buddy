...
class CommunityScreen extends ConsumerWidget {
              ...
              if (isDesktop) {
                return Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 3,
                      child: _buildSocietyLeaderboardCard(context, ref),
                    ),
                  ],
                );
              } else {
                return Column(
                  children: [
                    ...
                    const SizedBox(height: 32),
                    _buildSocietyLeaderboardCard(context, ref),
                  ],
                );
              }
            },
  ...
  Widget _buildSocietyLeaderboardCard(BuildContext context, WidgetRef ref) {
    final isLight = Theme.of(context).brightness == Brightness.light;
    final userState = ref.watch(userProvider);
    final myName = userState.value?.familyName ?? userState.value?.displayName ?? 'Your Household - You';
