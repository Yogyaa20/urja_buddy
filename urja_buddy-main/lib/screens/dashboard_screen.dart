...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  // ✅ AI Reduction Tips
  Future<void> _fetchReductionTip(double targetPercent, double currentKwh) async {
    if (mounted) setState(() => _isLoadingTip = true);
    try {
      final tip = await _aiService.getAIResponse(
        'My current electricity usage is ${currentKwh.toStringAsFixed(0)} kWh this month. '
        'I want to reduce my consumption by ${targetPercent.toInt()}% to save '
        'Rs ${(currentKwh * 8.5 * targetPercent / 100).toStringAsFixed(0)} per month. '
        'Give me 2-3 specific, practical tips to achieve this goal for an Indian household. '
        'Keep response under 60 words.',
      );
      if (mounted) setState(() => _aiReductionTip = tip);
    } catch (e) {
      if (mounted) setState(() => _aiReductionTip = 'Could not fetch tips. Please try again.');
    } finally {
            ...
            children: [
              ...
              Row(children: [
                ...
                Padding(
                  ...
                  child: Text('Smart Energy Analytics',
  ...
  Widget _buildMetricsRow(BuildContext context, EnergyData data) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Row(
        children: metrics
            .map((m) => Expanded(
                child: Padding(padding: const EdgeInsets.symmetric(horizontal: 8), child: m)))
            .toList(),
      );
    });
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: statusColor.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(16)),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('• Daily Avg: ${dailyUsage.toStringAsFixed(1)} kWh',
        ...
        children: [
          ...
          Text(text,
              style: const TextStyle(
                  color: UrjaTheme.primaryGreen, fontSize: 12, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
  ...
  Widget _buildPredictedVsCurrentCard(BuildContext context, double currentKwh, EnergyData energyData) {
    final dynamicPredicted =
        currentKwh > (_nextMonthKwh * 0.8) ? (currentKwh * 1.2) : _nextMonthKwh;
                        ...
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            title: const Text('Detailed Breakdown',
                                style: TextStyle(color: UrjaTheme.textPrimary)),
                            content: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(_aiAuditResult['insight'] ?? 'Analyzing...',
              style: TextStyle(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: Text("Action: ${_aiAuditResult['action']}",
                      style: TextStyle(
  ...
  Widget _buildProgressBar(
      BuildContext context, String label, double value, double max, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildSixMonthTrendCard(BuildContext context, double currentMonthlyKwh,
    ...
    if (_selectedTrendTab == 0) {
      ...
      maxY = ((maxVal * 1.2) > (currentDailyKwh * 1.5) ? (maxVal * 1.2) : (currentDailyKwh * 1.5))
          .clamp(20.0, 50000.0);
    } else if (_selectedTrendTab == 1) {
              ...
              BarChartData(
                ...
                barTouchData: BarTouchData(
                  ...
                  touchTooltipData: BarTouchTooltipData(
                    ...
                    getTooltipItem: (group, groupIndex, rod, rodIndex) {
                      final label = _selectedTrendTab == 0
                          ? 'Daily'
                          : _selectedTrendTab == 1
                              ? 'Monthly'
                              : 'Yearly';
                      return BarTooltipItem(
                          ...
                          const TextStyle(
                              color: UrjaTheme.primaryGreen, fontWeight: FontWeight.bold));
                    },
                  ),
                ),
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        return Text('${value.toInt()}',
                            style: const TextStyle(
                                color: UrjaTheme.textSecondary, fontSize: 10));
                      },
                    ),
                  ),
                ...
                gridData: FlGridData(
                  ...
                  getDrawingHorizontalLine: (value) =>
                      FlLine(color: UrjaTheme.glassBorder, strokeWidth: 1, dashArray: [5, 5]),
                ),
  ...
  // ✅ UPDATED: Reduction Goal Card with AI connected
    ...
    return GlassCard(
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: UrjaTheme.primaryGreen.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(color: UrjaTheme.primaryGreen.withValues(alpha: 0.3)),
                ),
                child: const Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.auto_awesome, color: UrjaTheme.primaryGreen, size: 12),
                    SizedBox(width: 4),
                    Text('AI Connected',
                        style: TextStyle(
                            color: UrjaTheme.primaryGreen,
          ...
          const SizedBox(height: 24),
          Text('Target Reduction', style: Theme.of(context).textTheme.bodyMedium),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
              ...
              const SizedBox(width: 12),
              Text('${_reductionTargetPercent.toInt()}%',
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Estimated Monthly Savings',
                        style: TextStyle(color: Colors.white70, fontSize: 12)),
                    Text('₹${_estimatedSavings.toStringAsFixed(2)}',
                        style: const TextStyle(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: _isLoadingTip
                  ? null
                  : () => _fetchReductionTip(_reductionTargetPercent, currentKwh),
              icon: _isLoadingTip
                  ? const SizedBox(
                      width: 16,
                      height: 16,
              ...
              label: Text(_isLoadingTip
                  ? 'Getting AI Tips...'
                  : _aiReductionTip.isEmpty
                      ? 'Get AI Tips to Reach Goal'
                      : 'Refresh AI Tips'),
              style: ElevatedButton.styleFrom(
                backgroundColor: UrjaTheme.primaryGreen,
                foregroundColor: Colors.white,
                disabledBackgroundColor: UrjaTheme.primaryGreen.withValues(alpha: 0.6),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    ...
                    UrjaTheme.primaryGreen.withValues(alpha: 0.04),
                  ],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
              ...
              child: Column(
                ...
                children: [
                  const Row(
                    children: [
                      Icon(Icons.lightbulb_rounded, color: UrjaTheme.primaryGreen, size: 16),
                      SizedBox(width: 8),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text('Enter your meter readings to calculate usage.',
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (prev != null && curr != null) {
                try {
                  await _energyService.saveMeterReading(
  ...
  void _showResetTodayDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("This will reset today's usage to 0. This action cannot be undone.",
  ...
  void _showResetTrendDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Choose what to reset. This action cannot be undone.',
            style: TextStyle(color: UrjaTheme.textSecondary)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
