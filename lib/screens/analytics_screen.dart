...
class _AnalyticsScreenState extends ConsumerState<AnalyticsScreen> {
                      ...
                      return Row(
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                _buildPredictedVsCurrentCard(context, ref, liveKwh, energyData),
                                const SizedBox(height: 32),
  ...
  Widget _buildPredictedVsCurrentCard(BuildContext context, WidgetRef ref, double currentKwh, EnergyData energyData) {
    ...
    // Fix: Use TariffService for accurate bill calculation instead of simple flat rate
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: Theme.of(context).brightness == Brightness.light ? const Color(0xFF1B5E20) : UrjaTheme.primaryGreen, width: 2),
