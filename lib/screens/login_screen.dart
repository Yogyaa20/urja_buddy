...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    if (_familyNameController.text.isEmpty || _passwordController.text.isEmpty) {
    ...
    try {
      await _authService.signInWithFamilyName(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.family_restroom_outlined, color: UrjaTheme.textSecondary),
                          filled: true,
