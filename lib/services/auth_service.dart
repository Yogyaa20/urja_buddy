...
class AuthService {
  ...
  // Sign in with family name and password
  Future<UserCredential> signInWithFamilyName(String familyName, String password) async {
    try {
      ...
      if (querySnapshot.docs.isEmpty) {
        throw Exception('Family name not found');
      }
